...
export const putToAPI = ({ url, data }) =>
  requestToAPI('put', `${url}/${data.id}`, data)
export const patchToAPI = ({ url, data }) =>
  requestToAPI('patch', `${url}/${data.id}/toggle`, data)
export const deleteToAPI = ({ url, data }) =>
  requestToAPI('delete', `${url}/${data.id}`)
